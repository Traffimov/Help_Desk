...
@Service
public class DeclineStatusAction extends UpdateStatusAction {

    private static final List<State> MANAGER_ALLOWED_STATES = List.of(State.NEW);

    public DeclineStatusAction(UserService userService, TicketDao ticketDao,
    ...
    protected void doUpdateStatus(EmailDataHolder emailDataHolder, Ticket ticket) {
        ...
        emailDataHolder.setTemplate(Template.DECLINED_TICKET);
    }
